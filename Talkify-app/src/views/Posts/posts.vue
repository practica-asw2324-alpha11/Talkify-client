        ...
        <el-col :span="4" style="display: flex; justify-content: flex-end;">
          <div class="dropdown" >
            <el-select v-model="selectedOption" placeholder="Select an option"   suffix-icon= "Filter" @change="handleDropdownChange" color="rgb(0,0,0)"  >
              <el-option class="desplegable" label="All" value=""></el-option>
              <el-option class="desplegable" label="Links" value="links"></el-option>
              <el-option class="desplegable" label="Threads" value="threads"></el-option>
            </el-select> 
          </div>
        </el-col>
      </el-row>
...
.el-select-dropdown__item:hover {
  background-color: rgba(85, 1, 149, 0.098);
}
